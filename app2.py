...
#with open('C:/Users/pradhma/Documents/Model Deployment/bin31May.pkl', 'rb') as file:
	#binz = pickle.load(file)
#with open('C:/Users/pradhma/Documents/Model Deployment/model31May.pkl', 'rb') as file:
